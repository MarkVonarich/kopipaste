...
Events: `mini_app_opened`, `mini_app_tab_opened`, `mini_app_workspace_changed`, `mini_app_period_changed`, `mini_app_transaction_add_opened`, `mini_app_transaction_created`, `mini_app_transaction_edited`, `mini_app_transaction_deleted`, `mini_app_theme_changed`, `mini_app_analytics_chart_filter_changed`, `mini_app_goal_created`, `mini_app_goal_contribution_added`, `mini_app_goal_plan_changed`, `mini_app_budget_limit_created`, `mini_app_budget_limit_updated`, `mini_app_budget_limit_deleted`, `mini_app_premium_opened`, `mini_app_notification_setting_changed`, `mini_app_export_opened`, `mini_app_home_challenge_opened`, `mini_app_home_focus_opened`, `mini_app_home_insight_opened`, `mini_app_profile_section_opened`, `mini_app_profile_setting_changed`.

Purpose is Telegram Mini App adoption, navigation, transaction, analytics, goals, limits and profile funnel measurement. Allowed properties are coarse UI codes such as `surface`, `tab`, `period`, `scope`, `action`, `operation_type`, `changed_fields`, `theme`, `chart_type`, `filter_kind`, `period_kind`, `kind`, `section`, `setting`, `result` and `source`. No user-entered text, operation descriptions, category names, goal names, limit names, exact dates, raw Telegram `initData`, tokens, secrets, prompts, responses or database identifiers.
